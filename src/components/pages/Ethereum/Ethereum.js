        ...
        <Card className='card'>
          <Card.Img variant="top" src="images/evolve.png" className='top' />
            <Card.Body>
                ...
                <br /><br /> 
                You're a farmer in Uganda that has no bank account, and has never been aproved for a loan. 
                A few years back you started buying ethereum as a way to store your wealth along with the rest of the community.
                ...
                <br /><br />
                Smarct Contracts allow an investing group in Atlanta that owns 100 ethereum to loan their money out and earn interest.
                <br /><br />
                ...
                When you finish paying the loan, the community gets the 15 Ethereum back they put up as collateral. In the mean time, the community's ethereum has doubled in value!
                <br /><br />
