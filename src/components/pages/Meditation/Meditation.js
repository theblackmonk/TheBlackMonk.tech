        ...
        <Card className='card'>
          <Card.Img variant="top" src="images/med11.jpg" className='top' />
            <Card.Body>
                ...
                Sit in a chair, or on the floor. Set a timer for 5 minutes. Look directly in front of you and relax your gaze as if you were looking at a faraway mountain. Take 5 deep breaths. Close your eyes.
                ...
                <Card.Text className='body'>Focus on your breath. Eventually your mind will start to wander. Maybe you start thinking about some holiday shopping you want to do, or the party next weekend.
                 ...
                 Just observe from a neutral standpoint. It's like to relaxing a muscle. You cannot try to relax; relaxing is just the absence of trying anything.
